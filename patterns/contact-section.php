 ...
 * Slug: wow-signal/contact-section
...
<h2 class="wp-block-heading has-xx-large-font-size"><?php echo esc_html_x( 'Tell us what you are building', 'Pattern placeholder text', 'wow-signal' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"muted","fontSize":"large"} -->
<p class="has-muted-color has-text-color has-large-font-size"><?php echo esc_html_x( 'You will hear back from one of the two people who would actually do the work, within one working day.', 'Pattern placeholder text', 'wow-signal' ); ?></p>
<!-- /wp:paragraph -->
...
<li><?php echo esc_html_x( 'A written scope and a fixed number before anything starts', 'Pattern placeholder text', 'wow-signal' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php echo esc_html_x( 'No sales call, no discovery workshop invoice', 'Pattern placeholder text', 'wow-signal' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php echo esc_html_x( 'We will tell you if your project is not a fit for us', 'Pattern placeholder text', 'wow-signal' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column -->
...
<div class="wp-block-group is-style-card"><!-- wp:wow/contact-form {"consentText":"<?php echo esc_attr_x( 'We use your details only to answer this enquiry and delete them after twelve months.', 'Pattern placeholder text', 'wow-signal' ); ?>"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></section>
<!-- /wp:group -->
