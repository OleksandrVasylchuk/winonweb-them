 ...
 * Slug: qwerty-soft-signal/cta-band
...
<h2 class="wp-block-heading has-xxx-large-font-size"><?php echo esc_html_x( 'Ready to stop losing visitors to a slow site?', 'Pattern placeholder text', 'qwerty-soft-signal' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"muted","fontSize":"large"} -->
<p class="has-muted-color has-text-color has-large-font-size"><?php echo esc_html_x( 'Send us the URL. We will tell you what is wrong with it, for free, before you decide anything.', 'Pattern placeholder text', 'qwerty-soft-signal' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/contact/#qwerty_soft_contact"><?php echo esc_html_x( 'Get a free review', 'Pattern placeholder text', 'qwerty-soft-signal' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></section>
<!-- /wp:group -->
